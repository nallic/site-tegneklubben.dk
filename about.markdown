...
<div class="about-page">
  ...
  <section class="about-section">
    <h2>Hvordan Deltager Du?</h2>
    <div class="steps-grid">
      <div class="step-card">
        <span class="step-number">1</span>
        <h3>Tilmeld Nyhedsbrevet</h3>
        <p>Få besked om nye arrangementer og tegnetips direkte i din indbakke.</p>
        <a href="{{ site.mailing_list.url }}" target="_blank" class="btn btn-small">Tilmeld Dig</a>
      </div>
      <div class="step-card">
        <span class="step-number">2</span>
        <h3>Deltag i Arrangementer</h3>
        <p>Tjek vores arrangementsoversigt og meld dig til det der passer dig.</p>
        <a href="{{ '/arrangementer/' | relative_url }}" class="btn btn-small">Se Arrangementer</a>
      </div>
      <div class="step-card">
        <span class="step-number">3</span>
        <h3>Bliv Aktiv</h3>
        <p>Del dine erfaringer, skriv om dine oplevelser eller hjælp til med arrangementer.</p>
        <a href="{{ '/kontakt/' | relative_url }}" class="btn btn-small">Kontakt Os</a>
      </div>
    </div>
  </section>
